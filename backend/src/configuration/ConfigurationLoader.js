...
const ENVIRONMENT_BINDINGS = Object.freeze([
  ...
  ["GITHUB_ADVISORY_API_URL", "githubAdvisories.apiUrl", "string"],
  ["GITHUB_ADVISORY_API_VERSION", "githubAdvisories.apiVersion", "string"],
  ["GITHUB_ADVISORY_TIMEOUT_MS", "githubAdvisories.timeoutMs", "positiveInteger"],
  ["GITHUB_ADVISORY_MAX_ATTEMPTS", "githubAdvisories.maxAttempts", "positiveInteger"],
  ["GITHUB_ADVISORY_RETRY_DELAY_MS", "githubAdvisories.retryDelayMs", "positiveInteger"],
  ["GITHUB_ADVISORY_CONCURRENCY", "githubAdvisories.concurrency", "positiveInteger"],
